...
const en = {
  ...
  // Promo form
  "promo.aria": "Setanta Bet free spins promotion",
  "promo.kicker": "Setanta Bet · Bonus play",
  "promo.title": "Guess a finalist, win 50 free spins",
  "promo.sub":
    "You've called your two finalists. If either reaches the real final, 50 free spins land on the Setanta Bet account associated with your phone number or email after the championship ends.",
  ...
  "promo.hint": "Spins are credited to the Setanta Bet account matching this contact.",
  "promo.submit": "Claim my 50 free spins",
  ...
  "promo.done.sub":
    "If you guessed a finalist right, 50 free spins will be waiting on the Setanta Bet account associated with your phone number or email after the championship ends.",
...
const ka: Record<StringKey, string> = {
  ...
  "promo.aria": "სეტანტა ბეთის უფასო დატრიალებების აქცია",
  "promo.kicker": "სეტანტა ბეთი · ბონუს თამაში",
  "promo.title": "გამოიცანი ფინალისტი, მოიგე 50 უფასო დატრიალება",
  "promo.sub":
    "შენ უკვე დაასახელე ორი ფინალისტი. თუ რომელიმე მათგანი ნამდვილ ფინალში გავა, 50 უფასო დატრიალება დაგხვდება სეტანტა ბეთის ანგარიშზე, რომელიც შენს ტელეფონის ნომერთან ან ელფოსტასთან არის დაკავშირებული, ჩემპიონატის დასრულების შემდეგ.",
  ...
  "promo.hint": "დატრიალებები ჩაირიცხება ამ კონტაქტთან დაკავშირებულ სეტანტა ბეთის ანგარიშზე.",
  "promo.submit": "მივიღო ჩემი 50 უფასო დატრიალება",
  ...
  "promo.done.sub":
    "თუ ფინალისტი სწორად გამოიცანი, 50 უფასო დატრიალება დაგხვდება სეტანტა ბეთის ანგარიშზე, რომელიც შენს ტელეფონის ნომერთან ან ელფოსტასთან არის დაკავშირებული, ჩემპიონატის დასრულების შემდეგ.",
